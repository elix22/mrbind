...
namespace mrbind::CInterop
{
    ...
    struct BasicFuncLike
    {
        MBREFL_STRUCT(
            (Comment)(comment)
            // An additional comment explaining the lifetime annotations on this function.
            // Print it after `comment` if your target language respects those annotations.
            (Comment)(comment_extra_lifetimes)
